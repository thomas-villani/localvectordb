...
class TextFileExtractor(BaseExtractor):
    ...
    def supported_extensions(self) -> List[str]:
        return [".txt", ".text", ".nfo", ".info", ".readme", ".log", ".out", ".err", ".lst", ".list", ".trace",
                ...
                ".swift", ".kt", ".kts", ".scala", ".sc", ".r", ".m", ".jl", ".pl", ".pm", ".t", ".rb", ".erb", 
                ".gemspec", ".php", ".phtml", ".php3", ".php4", ".php5", ".phpt", ".twig", ".mustache", ".hbs", 
                ".ejs", ".liquid", ".njk", ".jinja", ".jinja2", ".lua", ".hs", ".lhs", ".elm", ".purs", ".ml", 
                ".mli", ".mll", ".mly", ".erl", ".hrl", ".ex", ".exs", ".clj", ".cljs", ".cljc", ".edn", ".lisp",
                ".lsp", ".cl", ".el", ".scm", ".ss", ".rkt", ".d", ".nim", ".nimble", ".zig", ".vala", ".vapi", ".f",
                ".for", ".f77", ".f90", ".f95", ".f03", ".f08", ".ada", ".adb", ".ads", ".asm", ".s", ".v", ".vh",
                ".sv", ".svh", ".vhd", ".vhdl", ".g4", ".bnf", ".ebnf", ".idl", ".thrift", ".proto", ".avdl",
                ".graphql", ".gql", ".sas", ".do", ".ado", ".sps", ".q", ".coffee", ".cjsx", ".litcoffee", ".svelte",
                ".vue", ".astro", ".marko", ".cfm", ".cfc", ".cfml", ".pro", ".pri", ".idr", ".ipkg", ".agda", ".lean",
                ".als", ".tla", ".ll", ".mir", ".mlir", ".groovy", ".gvy", ".xsl", ".xslt", ".xsd", ".dtd", ".wsdl",
                ".svg", ".rss", ".atom", ".css", ".scss", ".sass", ".less", ".styl", ".stylus", ".pcss", ".postcss",
                ".pug", ".jade", ".haml", ".slim", ".aspx", ".cshtml", ".vbhtml", ".jsp", ".jspx", ".tag",
                ".tagx", ".ftl", ".vm", ".eex", ".leex", ".heex", ".mjml", ".csv", ".tsv", ".psv", ".ssv", ".dsv",
                ".json", ".json5", ".hjson", ".jsonl", ".ndjson", ".map", ".jsonld", ".yaml", ".yml", ".toml", ".ini",
                ".cfg", ".conf", ".cnf", ".cf", ".config", ".properties", ".prefs", ".editorconfig", ".env", ".dotenv",
                ".rc", ".plist", ".xaml", ".hcl", ".tf", ".tfvars", ".nomad", ".rego", ".cue", ".star", ".template",
                ".lock", ".prototxt", ".cmake", ".mak", ".mk", ".make", ".ninja", ".bazel", ".bzl", ".buck", ".gn",
                ".gyp", ".gypi", ".gradle", ".ivy", ".sln", ".vcxproj", ".csproj", ".fsproj", ".vbproj", ".proj",
                ".props", ".targets", ".nuspec", ".podspec", ".dot", ".gv", ".gml", ".mm", ".plantuml", ".puml",
                ".iuml", ".mmd", ".mermaid", ".wsd", ".rdf", ".ttl", ".n3", ".nt", ".trig", ".arff", ".geojson",
                ".topojson", ".kml", ".gpx", ".osm", ".vrt", ".prj", ".wkt", ".qgs", ".srt", ".vtt", ".sub", ".ssa",
                ".ass", ".lrc", ".cue", ".m3u", ".m3u8", ".pls", ".po", ".pot", ".strings", ".resx", ".y", ".l",
                ".feature", ".story", ".bats", ".tap", ".snap", ".spec", ".sh", ".bash", ".zsh", ".fish", ".csh",
